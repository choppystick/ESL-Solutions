...
, where $N_k(x)$ is the neighborhood of $x$ defined by the $k$ closest points $x_i$ in the training sample, where . In this case, we quantify closeness with the Euclidean norm $||x||_2$. 
